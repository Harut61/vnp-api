 ...
 */
final class Version20210205034041 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE source_videos CHANGE status status VARCHAR(20) DEFAULT \'UPLOADED\' NOT NULL, CHANGE source_id major_source_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE source_videos CHANGE status status VARCHAR(20) CHARACTER SET utf8mb4 DEFAULT \'CREATED\' NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE major_source_id source_id INT DEFAULT NULL');
