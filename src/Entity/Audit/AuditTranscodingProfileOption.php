...
/**
 * Audit
 * @ORM\Table(name="audit_transcoding_profile_option")
 * @ORM\Entity
 *  @ApiResource(
 ...
 */
class AuditTranscodingProfileOption extends BaseAudit
{

    /**
     * @Groups({"id:read"})
     * @var string
     ** @ORM\ManyToOne(targetEntity="App\Entity\TranscodingProfileOption")
     * @MaxDepth(1)
     */
    public $object;
}
